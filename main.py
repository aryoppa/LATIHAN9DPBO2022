...
hunians.append(Indekos("Chuck McGill", "Howard Hamlin", 750, 15))
...
def details(index):
    ...
    exit_button = Button(opts, text="Exit", command=top.destroy)
    ...
    if hunians[index].get_jenis() != 'Indekos':
        d_summary = Label(d_frame, text = "Summary: " + hunians[index].get_summary() +
                    ...
                    "\nKapasitas Listrik: " + str(hunians[index].get_kap_listrik()) + " VA" +
